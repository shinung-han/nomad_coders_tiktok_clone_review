...
import 'package:tiktok_clone_2/features/users/view_models/users_view_model.dart';
import 'package:tiktok_clone_2/features/users/widgets/avatar.dart';
import 'package:tiktok_clone_2/features/users/widgets/persistent_tab_bar.dart';
import 'package:tiktok_clone_2/features/users/widgets/user_account.dart';
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  const UserAccount(
                                      count: '97', text: 'Following'),
                                  _verticalDivider(),
                                  const UserAccount(
                                      count: '10.5M', text: 'Followers'),
                                  _verticalDivider(),
                                  const UserAccount(
                                      count: '149.3M', text: 'Likes'),
                                ],
                              ),
                            ),
                            Gaps.v14,
